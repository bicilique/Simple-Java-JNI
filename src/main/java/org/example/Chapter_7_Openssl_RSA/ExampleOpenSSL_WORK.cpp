...
int main() {
    ...
    BIO *bio = BIO_new_fp(stdout, BIO_NOCLOSE);  // Print to stdout
    ...
    unsigned char encrypted[256];  // Make sure this is large enough for your key size
    unsigned char decrypted[256];  // Make sure this is large enough
